...
public partial class MainForm : MetroForm
{
        ...
        while (true)
        {
            try
            {
                ...
                try
                {
                    ...
                    if (gunaLineTextBox32.Text.Contains(","))
                    {
                        siticoneCheckBox39.Text = "Multiple Buttons (" + Microsoft.VisualBasic.Strings.Split(gunaLineTextBox32.Text, ",").Length.ToString() + ")";
                    }
                    else
                    {
                        siticoneCheckBox39.Text = "Multiple Buttons";
                    }
    ...
    private void siticoneCheckBox38_CheckedChanged(object sender, EventArgs e)
    {
        if (siticoneCheckBox38.Checked)
        {
    ...
    private void siticoneCheckBox36_CheckedChanged(object sender, EventArgs e)
    {
    ...
    {
        // Button Spammer - Start Spamming
        gunaButton21.Enabled = false;
        gunaButton14.Enabled = true;
    }

    private void gunaButton14_Click(object sender, EventArgs e)
    {
        // Button Spammer - Stop Spamming
        gunaButton14.Enabled = false;
        gunaButton21.Enabled = true;
    }
